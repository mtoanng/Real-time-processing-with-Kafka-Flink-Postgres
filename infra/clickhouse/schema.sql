...
CREATE TABLE IF NOT EXISTS taobao_behavior.product_catalog_current_queue (
    ...
    is_active Bool, updated_at_ms Int64, catalog_version Int64
) ENGINE = Kafka SETTINGS
    kafka_broker_list = 'kafka:29092',
    kafka_topic_list = 'taobao-product-catalog-current',
...
SELECT toUInt64(product_id) AS product_id, toUInt64(category_id) AS category_id,
    ...
    fromUnixTimestamp64Milli(updated_at_ms) AS updated_at,
