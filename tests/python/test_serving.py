...
class FakeRedis:
    def hgetall(self, key: str) -> dict[str, str]:
        if "active_cart" in key:
            return {"101": "11|1511658004000|1511658005000"}
        return {
            "feature_version": "1511658060000",
            "feature_id": "38c38b848ae4916330b95a1bf40d3d77ad5a4bae0e1afb2d72700e7896c9aa56",
            "window_start": "2017-11-26 01:00:00.000",
            "window_end": "2017-11-26 01:01:00.000",
            "event_count": "5",
            "pv_count": "1",
            "cart_count": "3",
            "fav_count": "0",
...
class ServingContractTests(unittest.TestCase):
    ...
    def test_features_return_typed_latest_redis_snapshot(self) -> None:
        actual = FixtureServingStore().features(1)
        self.assertEqual(
            EXPECTED["features"],
            {key: actual[key] for key in ("user_id", "available", "features")},
        )
        self.assertEqual(86_342, actual["ttl_seconds"])
