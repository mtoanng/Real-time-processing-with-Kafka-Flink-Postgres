...
This directory is the active evidence location for the bounded core correctness
and recovery refactor.
...
No live Kafka, Flink, ClickHouse, Cassandra, CDC, or cloud execution is claimed
