...
from taobao_serving.redis_features import feature_key
...
class ServingStore:
    ...
    def features(self, user_id: int) -> dict[str, object]:
        """Read the latest closed event-time feature snapshot for one user."""
        ...
        normalized = {
            field: int(value) if field in integer_fields else value
